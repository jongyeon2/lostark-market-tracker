...
- [x] **Phase 10: Event Impact** — 이벤트별 전후 변화율 + ok/insufficient_data + 상관≠인과 문구 (completed 2026-06-26)
- [x] **Phase 11: Demo Surface + Docs** — seed 재현 + frontend/README + 루트 README + (선택) 정적 서빙 (completed 2026-06-27)
