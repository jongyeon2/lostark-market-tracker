...
- [x] **Phase 14: Frontend Icons + Fallback + Docs** — 공용 `<ItemIcon>` + 3화면·셀렉터 아이콘·역할 배지 + docs (completed 2026-06-29)
...
| 14. Frontend Icons + Fallback + Docs | v1.2 | 3/3 | Complete   | 2026-06-29 |
