...
// Hand-authored shadcn new-york Select block over @radix-ui/react-select.
// Authored by hand (not via `npx shadcn add select`) because that CLI path
// misplaces the block into a literal `@/` directory and injects a stray
// `radix-ui` umbrella package on this Windows setup. Consumed by 09-02 ItemSelect (D-05).
