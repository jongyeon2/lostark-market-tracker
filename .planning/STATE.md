...
Milestone: v1.8 보석 기록 + 대시보드 통합 — Phase 27 **계획 완료(0/2 실행)**, Phase 28 **UI-SPEC 대기**. 직전 v1.7(Phase 24·26) 완료
Next: **Phase 27 실행**(27-01 기록 파이프라인 → 27-02 라벨 제거) → **Phase 28 UI-SPEC**(대시보드 통합).
