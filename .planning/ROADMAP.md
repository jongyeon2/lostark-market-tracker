...
- [x] **Phase 22** 재련 재료 추적 확대 (MKT-02) — **완료 2026-07-14**: 신규 19종(재련기본 7·상급재련 6[업화 15-18·19-20]·아크그리드젬 6) WatchlistSeeder 편입(22→41). 아크그리드젬 포함(거래소). **수집/캐시/event-impact 로직 0줄**, SyntheticDemoData 무변경(동적 로드). `./gradlew build` 그린(WatchlistSeederIT 41종·MATERIAL 23 증명). 22b: [19-20] DESC 스파이크로 실측·편입.
...
| 22. 재련 재료 추적 확대 | v1.5 | 1/1 | Complete — 워치리스트 22→41 | 2026-07-14 |
