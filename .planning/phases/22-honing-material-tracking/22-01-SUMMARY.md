...
> **⚠️ 후속 교정 (quick-260714, 2026-07-14):** 아래 "상급재련 6[업화 15-18·19-20]" 분류는 **도메인 오류**였다.
> 업화 계열은 일반 재련 성공률 보조 재료이고 숨결(용암/빙하)은 상급·일반 재련 겸용이라 **둘 다 `재련보조`로 재분류**,
> 진짜 상급 재련 전용 재료는 **장인의 야금술/재봉술 1~4단계**다(quick-260714에서 8종 신규 편입). 결과: item_group=상급재련은
> 장인 책 8종, 재련보조=숨결 2+업화 4=6종. 최종 워치리스트 **49**, MATERIAL 31, item_group 6종.
> 상세: `.planning/quick/260714-sxn-refine-material-reclassify/` · `21-SPIKE-FINDINGS.md §(e)`.
