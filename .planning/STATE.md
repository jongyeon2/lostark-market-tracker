...
Last activity: 2026-07-15 -- quick-260715-eeg 완료(소식 패널: 만료 이벤트 필터 실버그 수정 + 라벨/쿠폰 표시 정리). 다음: quick-A(대시보드 카테고리 — 각인서 구분선/아이콘 + 강화재료→재련재료 이관, Flyway V7 필수) → Phase 24(event-impact 백필 폴백 앵커)
