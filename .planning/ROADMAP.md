...
- 🚧 **v1.7 경매장 보석 현재가** — Phase 24 ✅ 완료 · Phase 26 진행중 (착수 2026-07-15) — v2로 미뤄둔 `SRC-V2-01`(경매장/보석 소스 확장) 실현. **티어4 8~10레벨 보석만**, 별도 `/gems` 페이지
...
### 🚧 v1.7 경매장 보석 현재가 (Phase 24, 26) — IN PROGRESS (착수 2026-07-15)
...
| 26. 보석 현재가 둘러보기 `/gems` | v1.7 | 0/? | Planned — UI-SPEC 선행 | — |
