...
- **`WatchlistSeeder`:** 업화 4종(66112551/552/553/554) `상급재련`→**`재련보조`** 재분류. 장인 책 **8종 신규**
  (category=50020, item_group=상급재련, role=MATERIAL). 숨결 2종 상급재련 유지. **41→49**(MATERIAL 23→31).
  헤더/클래스 javadoc 카운트·그룹·도메인 교정 노트 갱신.
- **`WatchlistSeederIT`:** hasSize 41→49, MATERIAL 23→31L, itemGroup isIn +`재련보조`, 멱등 49, 66112551 샘플=재련보조,
  장인 책 상급재련 샘플(66112717, 고대/use_13_223) 추가.
...
재료 세분에서 상급재련(장인 책)과 재련보조(업화)를 별도 소그룹으로 자연스럽게 분리 가능.
